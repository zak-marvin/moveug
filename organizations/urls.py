...
from .views import (OrganizationListCreateView, OrganizationDriverRosterView,
                     ...
                     OrganizationScheduleListView, OrgScheduleListView, OrgOpportunitiesListView,
                     OrgBidListCreateView, MyOrgBidView, EditOrgBidView, AcceptOrgBidView)
...
urlpatterns = [
    ...
    path('<int:organization_id>/schedules/', OrgScheduleListView.as_view(), name='org-schedule-list'),
    ...
    path('schedule/<int:booking_id>/bids/mine/', MyOrgBidView.as_view(), name='org-bid-mine'),
    path('schedule/<int:booking_id>/bids/<int:bid_id>/', EditOrgBidView.as_view(), name='org-bid-edit'),
